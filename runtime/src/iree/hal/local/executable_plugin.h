...
// IREE runtime plugin it is allowed to return full iree_status_t objects
// across the boundary so long as the hosting runtime was compiled with
// IREE_STATUS_MODE > 0 (otherwise the runtime won't know how to deal with
// them). Plugins using this functionality must declare the feature bit
